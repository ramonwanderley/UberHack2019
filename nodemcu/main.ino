...
void loop() {
  ...
  if (WiFi.status() == WL_CONNECTED) { //Check WiFi connection status
    ...
    JSONencoder["operation"] = "available";
    JSONencoder["id"] = "1";
    ...
    http.begin("https://x647przbde.execute-api.us-east-1.amazonaws.com/default","E6:8D:15:A0:C3:FD:67:F7:B2:DF:69:93:6C:80:A8:50:0C:85:EE:9A");      //Specify request destination
